        ...
        <div className="px-4 py-4">
          {!isEditingPassword ? (
            <button
              ...
              className="flex items-center justify-between w-full py-2 px-3 border border-gray-300 rounded-md text-xs font-medium text-gray-700 bg-white hover:bg-gray-50"
            >
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-3">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="py-2 px-4 border border-transparent shadow-sm text-xs font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700 disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className="py-2 px-4 border border-gray-300 shadow-sm text-xs font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
                >
                  Cancel
                </button>
              </div>
